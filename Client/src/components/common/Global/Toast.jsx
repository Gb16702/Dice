...
const Toast = ({message, type, visible, variant, dark}, t) => {
    ...
    } max-w-md w-full ${dark ? "bg-zinc-800" : "bg-white"} shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5`}
  >
    <div className="flex-1 w-0 p-4 h-full">
      <div className="flex items-start h-full">
        ...
        <div className="ml-3 flex-1">
          <p className={`text-sm ${dark ? "text-zinc-100" : "text-zinc-900"} font-semibold`}>
            {type}
          </p>
