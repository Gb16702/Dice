    ...
    return <section className="h-[100vh] flex items-center justify-center bg-gradient-to-b from-[#F7F7F7] to-[#EEE] relative">
        <div className="flex items-center justify-center flex-col w-[1000px]">
            <div className="w-[330px] flex items-center flex-col">
                <FormEnglober>
                <h1 className="font-semibold text-[26px] py-[5px] text-zinc-700/[.80] pb-[30px]">Crée ton compte</h1>
                    ...
                    <h3 className="mt-7 text-zinc-500">Tu as déjà un compte ? <Link href="/connexion" className="text-[#603AD9]">Connecte-toi</Link></h3>
                </FormEnglober>
            </div>
        </div>
        <FormBottom />
