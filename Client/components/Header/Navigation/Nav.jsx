import Discord from "../../Globals/Icons/BrandLogos/Discord"
import Github from "../../Globals/Icons/BrandLogos/Github"
import NavItem from "./NavItem/NavItem"

const Nav = () => {
    return (
        <nav className="w-[1500px] bg-transparent h-full flex flex-row justify-between">
